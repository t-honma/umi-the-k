    ...
    <div class="inner">
        ...
        <nav>
            <ul class="eng">
				...
				<li><a href="https://www.489pro-x.com/ja/s/umithek/search/" target="_blank">RESERVATION</a></li>
            </ul>
...
<footer>
    <div class="inner">
        ...
        <p class="notice">
            ※臨時休業・営業時間変更となる場合があります。<br>
            ※時間外のお問い合わせにつきましては、下記CONTACT（お問い合わせ）よりお願いいたします。<br>
            ※お電話でのご予約は承っておりませんので、下記RESERVATION（宿泊予約）よりお待ちしております。
        </p>
        <div class="btn_wrap">
