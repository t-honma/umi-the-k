...
## フォームの宛先
push @mailto,'info@umithek.com';
##push @mailto,'honmat1974@gmail.com';

## 管理者宛メールのCC・BCCの宛先
#$config{'admin_cc'} = 'support@synck.com';
$config{'admin_bcc'} = 'honmat1974@gmail.com';
...
## 自動返信メールの差出人名
$config{'fromname'} = 'UMI THE K 古宇利島';
...
$config{'ThanksPage'} = 'https://umithek.com/contact/thanks.html';

## 設置者に届くメールの件名
$config{'subject'} = '[ %s ] UMI THE K お問い合せフォームから';
